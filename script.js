...
var submitHandler = function (event) {
    ...
    // pulled information from Activity 24

    if (cityName) {
        getWeathterofCity(cityName);
...
function showWeather(lat, lon) {
    fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=a8d4d4e0925590d16cc122c92ab2023c&units=imperial`)
        ...
        .then(function (data) {
            ...
            containerEl.append(tempEl, windEl, uviEl, humidityEl)
